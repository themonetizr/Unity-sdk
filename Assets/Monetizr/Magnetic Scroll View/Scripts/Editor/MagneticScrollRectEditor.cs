...
namespace MagneticScrollView
{
    ...
    {
        private SerializedProperty elements, viewport, indexTableManager, autoArranging, /*useButtons, useIndexTable,*/ alignment, layoutMode, curvature, inertia, decelerationRate, realtimeSelection, infiniteScrolling, smoothTransition, invertOrder, useMargin, rotate, snapMode,
        ...
        private void OnEnable ()
        {
            ...
            if (forwardButton.objectReferenceValue != null && backButton.objectReferenceValue != null)
                useButtons = (backButton.objectReferenceValue as GameObject).activeSelf && (backButton.objectReferenceValue as GameObject).activeSelf;
            if (indexTable.objectReferenceValue != null)
                useIndexTable = (indexTable.objectReferenceValue as GameObject).activeSelf;
        }
        ...
        private void RemoveButtons ()
        {
            ...
            {
                Undo.RegisterCompleteObjectUndo (backButton.objectReferenceValue, "Back button removed");
            ...
            {
                Undo.RegisterCompleteObjectUndo (forwardButton.objectReferenceValue, "Forward button removed");
